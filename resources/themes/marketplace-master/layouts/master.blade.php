                ...
                <div class="col-md-2">
                    @auth
                        ...
                        @if ($vendor_role  && !user()->hasRole($vendor_role))
                            {!! '<a href="' . url('marketplace/store/enroll') . '" class="btn btn btn-block" style="background-color: #071A10; color:white;">'.trans('Marketplace::labels.store.become_a_seller').'</a>' !!}
