...
<footer class="footer-one">
    <div class="inner-footer" style="background-color: #229954">
        <div class="container">
                 ...
                 <img class="img" src="{{asset('uploads/footer/laos.png')}}">
                  <img class="img" src="{{asset('uploads/footer/pakistan.png')}}">
                   <img class="img" src="{{asset('uploads/footer/malaysia.png')}}">
                    ...
                    <div class="tiva-html col-lg-3 col-md-6 text-center" style="margin-top: -20px;" >
...
<h1 style="margin-top: 40px; margin-bottom: 20px">Business</h1>
 <li>
 ...
 <li>
  <a style="color:white" class="text-center fot">Order Tracking</a>
                    ...
                    <div class="tiva-modules col-lg-3 col-md-6" style="margin-top: -15px;">
...
<img src="{{asset('uploads/footer/payment/tg.png')}}" height="40" width="70">
  ...
  <div class="row col2" style="margin-top: 50px;">
...
<img src="{{asset('uploads/footer/delivery/dhl.jpeg')}}" height="40" width="100">
    ...
    <div id="tiva-copyright" style="background-color:#229954">
        <div class="container">
            <div class="row">
                <div class="text-center col-lg-12 ">
                        ...
                        <p style="color:white">Copyright &copy;<?php echo date("Y"); ?> All rights reserved By Aladin.</p>
                </div>
            </div>
        </div>
    </div>
