...
<div id="watch-live-overlay">
                    <div id="overlay-container">
                            ...
                            <div class="col-md text-center" style="margin-top: -130px; width: 60%;">
                                    <button id="watch-live-btn" type="button" class="btn btn-block btn-success btn-xlg">
                                        <i style="color:#086E38" id="watch-live-icon" class="fas fa-broadcast-tower"></i><span style="color:#086E38">Watch the Live Stream</span>
                                    </button>
                                </div>
                    </div>
            </div>
  ...
  <div class="media-body">
     @if ($message = Session::get('success'))
        <div style="height: 30px; background-color: #086E38; " class="alert alert">
            <p style="color:white; margin-top:-5px">{{$message}}</p>
        </div>
    @endif
    @foreach($comments as $comment)
    <h5 class="mt-0 mb-1" style="font-weight: bold;">Hamid</h5>
...
<hr>
          <form class="ps-form--quick-search" style="margin-bottom: 10px" action="{{ route('watchstreams.store') }}" method="post">
 @csrf
           <input class="form-control" type="text" name="description" style="border-top-left-radius: 20px;border-bottom-left-radius: 20px; height: 30px;" placeholder="Trending Products..." id="input-search">
